...
- **Gaya Komunikasi yang Disukai**:
  ...
  - **Larangan Ketat OneDrive (Aturan Mutlak AGENT.md)**: File proyek Bima HARAM HUKUMNYA menyentuh OneDrive. Seluruh berkas rilis, pengujian, dan biner wajib disimpan di folder lokal proyek (`release-artifacts/` atau direktori kerja lokal), tidak boleh disalin atau ditaruh di folder OneDrive.
...
- **Status Implementasi Terkini**:
  ...
  - **Rilis Resmi GitHub (v0.3.1)**: Dipublikasikan di `https://github.com/Luciansvon/AI-COLOR-COMPARE/releases/tag/v0.3.1` lengkap dengan biner mandiri Windows `Studio-Color-QC-v0.3.1-Windows-x64.exe` (10.44 MB) dan paket `.zip`.
